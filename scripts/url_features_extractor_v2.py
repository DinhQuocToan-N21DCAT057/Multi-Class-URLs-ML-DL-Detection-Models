...
class URL_EXTRACTOR(object):
    ...
    def __init__(self, url, label="Unknown", enable_logging=False):
        ...
        self.crawling_results = subprocess.run(
            ["node", "nyarlathotep-web-crawler\crawling_chaos.js", url],
            capture_output=True,
            text=True,
        )
        ...
        self.url = self.content_features['url']
        self.label = label
    ...
    def extract_to_dataset(self):
        ...
        feature_funcs = [
            ...
            # Content's Features
            ("is_alive", self.content_features['is_alive']),
            ("is_empty_title", self.content_features['is_empty_title']),
            ("nb_forms", self.content_features['nb_forms']),
            ("nb_inputs", self.content_features['nb_inputs']),
            ("nb_buttons", self.content_features['nb_buttons']),
            ("nb_selects", self.content_features['nb_selects']),
            ("nb_textareas", self.content_features['nb_textareas']),
            ("nb_imgs", self.content_features['nb_imgs']),
            ("nb_embeds", self.content_features['nb_embeds']),
            ("nb_audios", self.content_features['nb_audios']),
            ("nb_videos", self.content_features['nb_videos']),
            ("nb_scripts", self.content_features['nb_scripts']),
            ("nb_a", self.content_features['nb_a']),
            ("nb_links", self.content_features['nb_links']),
            ("nb_iframes", self.content_features['nb_iframes']),
            ("nb_divs", self.content_features['nb_divs']),
            ("nb_spans", self.content_features['nb_spans']),
            ("nb_paragraphs", self.content_features['nb_paragraphs']),
            ("nb_headings", self.content_features['nb_headings']),
            ("nb_tables", self.content_features['nb_tables']),
            ("nb_table_rows", self.content_features['nb_table_rows']),
            ("nb_table_cells", self.content_features['nb_table_cells']),
            ("nb_ul_lists", self.content_features['nb_ul_lists']),
            ("nb_ol_lists", self.content_features['nb_ol_lists']),
            ("nb_list_items", self.content_features['nb_list_items']),
            ("nb_strongs", self.content_features['nb_strongs']),
            ("nb_ems", self.content_features['nb_ems']),
            ("nb_canvas", self.content_features['nb_canvas']),
            ("nb_svgs", self.content_features['nb_svgs']),
            ("nb_metas", self.content_features['nb_metas']),
            ("nb_styles", self.content_features['nb_styles']),
            ("nb_special_char", self.content_features['nb_special_char']),
            ("nb_ext_links", self.content_features['nb_external_links']),
            ("nb_ext_scripts", self.content_features['nb_external_scripts']),
            ("nb_ext_imgs", self.content_features['nb_external_images']),
            ("nb_input_types", self.content_features['nb_input_types']),
            ("nb_social_media_links", self.content_features['nb_social_media_links']),
            ("nb_social_buttons", self.content_features['nb_social_buttons']),
            ("content_txt_len", self.content_features['inner_text_len']),
            ("body_len", self.content_features['body_length']),
            ("script_len", self.content_features['script_length']),
            ("has_onclick", self.content_features['elements_with_onclick']),
            ("has_onmouse", self.content_features['elements_with_onmouse']),
            ("has_onload", self.content_features['elements_with_onload']),
            ("has_popup", self.content_features['has_popup_window']),
            ("has_right_click", self.content_features['has_right_click']),
            ("has_password_field", self.content_features['has_password_field']),
            ("has_file_upload", self.content_features['has_file_upload']),
            ("has_ssl", self.content_features['has_ssl']),
            ("has_captcha", self.content_features['has_captcha']),
            ("has_login_form", self.content_features['has_login_form']),
            ("has_date_stamps", self.content_features['has_date_stamps']),
            ("has_new_badges", self.content_features['has_new_badges']),
            ("has_copyright_year", self.content_features['has_copyright_year']),
            ("has_social_sharing", self.content_features['has_social_sharing']),
            ("has_ad_keywords", self.content_features['has_ad_keywords']),
            ("has_sus_ad_class", self.content_features['has_sus_ad_class']),
            ("has_popup_ad", self.content_features['has_popup_ad']),
            ("has_comment_sections", self.content_features['has_comment_sections']),
            ("has_rating_system", self.content_features['has_rating_system']),
            ("has_search_box", self.content_features['has_search_box']),
            ("has_view_port_meta", self.content_features['has_view_port_meta']),
            ("has_responsive_imgs", self.content_features['has_responsive_imgs']),
            ("has_mobile_css", self.content_features['has_mobile_css']),
            ("avg_sentence_len", self.content_features['avg_sentence_len']),
            ("avg_words_per_sentence", self.content_features['avg_words_per_sentence']),
            ("avg_paragraph_len", self.content_features['avg_paragraph_len']),
            ("readability_score", self.content_features['readability_score']),
            ("txt_to_html_ratio", self.content_features['txt_to_html_ratio']),
            ("txt_to_tag_ratio", self.content_features['txt_to_tag_ratio']),
            ("link_density", self.content_features['link_density']),
            ("img_density", self.content_features['img_density']),
            ("form_complexity", self.content_features['form_complexity']),
            ("unique_words_ratio", self.content_features['unique_words_ratio']),
            ("punctuation_density", self.content_features['punctuation_density']),
            ("punctuation_density", self.content_features['punctuation_density']),
